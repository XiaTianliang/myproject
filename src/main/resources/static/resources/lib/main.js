...
var Core = function(options) {
   ...
   var runSideMenu = function(options) {
      ...
      var sbOnLoadCheck = function() {
         ...
         // unique custom mobile resources classes
   ...
   var runAnimations = function() {
      ...
      // Add a class after load to prevent resources animations
   ...
   return {
      ...
      ,
      multiSelectCallback: function(callback) {
         $(".btn-group ul.multiselect-container").find("input[type='radio']").click(callback);
      }
