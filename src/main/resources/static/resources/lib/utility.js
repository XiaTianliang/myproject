   ...
   Multiselect.prototype = {
      ...
      buildDropdown: function() {
         ...
         if (this.options.maxHeight) {
            // TODO: Add a class for this option to move the resources declarations.
            this.$ul.css({
